...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("cryptoglobalpay-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("cryptoglobalpay-net");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("cryptoglobalpay-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "cryptoglobalpay " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("cryptoglobalpay-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("cryptoglobalpay-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("cryptoglobalpay-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("cryptoglobalpay-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. cryptoglobalpay is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("cryptoglobalpay-start");
